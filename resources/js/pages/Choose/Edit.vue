...
const form = useForm({
    ...
    subtitle: props.choose.subtitle,
    icon: props.choose.icon,
});


const submit = () => {
    form.put('/chooses/' + props.choose.id);
}
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="pt-10 lg:px-20 px-5">
            <div class="flex items-center justify-between">
                ...
                <LinkButton :label="'Back'" :url="'/choose'" />
            </div>
            ...
            <div class="border border-gray-200 p-10 mt-3 shadow rounded">
                <form @submit.prevent="submit">
                    <div class="space-y-3 mb-5">
                        ...
                        <div>
                            <Label forr="icon" :label="'Icon (Only svg)'" />
                            <textarea name="" id="" cols="30" rows="3" v-model="form.icon" placeholder="Enter your icon"
