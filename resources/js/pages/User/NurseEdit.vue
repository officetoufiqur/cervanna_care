                ...
                <form @submit.prevent="submit">
                   <div class="space-y-3 grid grid-cols-1 gap-5">
                        <div class="space-y-4">
                                ...
                                <div>
                                    <InputLabel forr="isNursingInKenya" :label="'isNursingInKenya'" v-model="form.isNursingInKenya" type="text"
                                        :placeholder="'isNursingInKenya'" readonly/>
                                    <span class="text-red-500 text-sm" v-if="form.errors.isNursingInKenya">{{ form.errors.isNursingInKenya }}</span>
                                </div>
                                <div>
                                ...
                                <div>
                                    <InputLabel forr="mobilityYears" :label="'mobilityYears'" v-model="form.mobilityYears" type="text"
                                        :placeholder="'mobilityYears'" readonly/>
                                    <span class="text-red-500 text-sm" v-if="form.errors.mobilityYears">{{ form.errors.mobilityYears }}</span>
                                </div>
                                <div>
                                    <InputLabel forr="bathingYears" :label="'bathingYears'" v-model="form.bathingYears" type="text"
                                        :placeholder="'bathingYears'" readonly/>
                                    <span class="text-red-500 text-sm" v-if="form.errors.bathingYears">{{ form.errors.bathingYears }}</span>
                                </div>
                                <div>
                                    <InputLabel forr="feedingYears" :label="'feedingYears'" v-model="form.feedingYears" type="text"
                                        :placeholder="'feedingYears'" readonly/>
                                ...
                                <div>
                                    <InputLabel forr="skills" :label="'skills'" v-model="form.skills" type="text"
                                        :placeholder="'skills'" readonly/>
                                    <span class="text-red-500 text-sm" v-if="form.errors.skills">{{ form.errors.skills }}</span>
                                </div>
