                ...
                <form @submit.prevent="submit">
                    <div class="space-y-3 mb-5">
                        ...
                        <div>
                            ...
                            <textarea name="" id="" cols="30" rows="5" v-model="form.answer" placeholder="Enter your answer" class="form-control"></textarea>
                            <span class="text-red-500 text-sm" v-if="form.errors.answer">{{ form.errors.answer }}</span>
                        </div>
                    </div>
